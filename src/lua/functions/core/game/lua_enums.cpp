...
void LuaEnums::initConditionParamEnums(lua_State* L) {
	...
	registerEnum(L, CONDITION_PARAM_SKILL_SMITHING);
	registerEnum(L, CONDITION_PARAM_SKILL_ENCHANTING);
	registerEnum(L, CONDITION_PARAM_SKILL_WOODCUTTING);
	registerEnum(L, CONDITION_PARAM_SKILL_FLETCHING);
	registerEnum(L, CONDITION_PARAM_SKILL_SKINNING);
	registerEnum(L, CONDITION_PARAM_SKILL_BUTCHERING);
	registerEnum(L, CONDITION_PARAM_SKILL_FARMING);
	registerEnum(L, CONDITION_PARAM_SKILL_COOKING);
	registerEnum(L, CONDITION_PARAM_SKILL_CRAFTING);
	registerEnum(L, CONDITION_PARAM_SKILL_HERBLORE);
	registerEnum(L, CONDITION_PARAM_SKILL_ALCHEMY);
	registerEnum(L, CONDITION_PARAM_SKILL_ARCHAEOLOGY);
	registerEnum(L, CONDITION_PARAM_SKILL_MUSIC);
	registerEnum(L, CONDITION_PARAM_SKILL_WISDOM);
	...
	registerEnum(L, CONDITION_PARAM_SKILL_SMITHINGPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_ENCHANTINGPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_WOODCUTTINGPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_FLETCHINGPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_SKINNINGPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_BUTCHERINGPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_FARMINGPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_COOKINGPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_CRAFTINGPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_HERBLOREPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_ALCHEMYPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_ARCHAEOLOGYPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_MUSICPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_WISDOMPERCENT);
