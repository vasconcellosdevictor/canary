...
bool IOLoginDataSave::savePlayerFirst(std::shared_ptr<Player> player) {
	...
	query << "`skill_woodcutting` = " << player->skills[SKILL_WOODCUTTING].level << ",";
	query << "`skill_woodcutting_tries` = " << player->skills[SKILL_WOODCUTTING].tries << ",";
	query << "`skill_fletching` = " << player->skills[SKILL_FLETCHING].level << ",";
	query << "`skill_fletching_tries` = " << player->skills[SKILL_FLETCHING].tries << ",";
	query << "`skill_skinning` = " << player->skills[SKILL_SKINNING].level << ",";
	query << "`skill_skinning_tries` = " << player->skills[SKILL_SKINNING].tries << ",";
	query << "`skill_butchering` = " << player->skills[SKILL_BUTCHERING].level << ",";
	query << "`skill_butchering_tries` = " << player->skills[SKILL_BUTCHERING].tries << ",";
	query << "`skill_farming` = " << player->skills[SKILL_FARMING].level << ",";
	query << "`skill_farming_tries` = " << player->skills[SKILL_FARMING].tries << ",";
	query << "`skill_cooking` = " << player->skills[SKILL_COOKING].level << ",";
	query << "`skill_cooking_tries` = " << player->skills[SKILL_COOKING].tries << ",";
	query << "`skill_crafting` = " << player->skills[SKILL_CRAFTING].level << ",";
	query << "`skill_crafting_tries` = " << player->skills[SKILL_CRAFTING].tries << ",";
	query << "`skill_herblore` = " << player->skills[SKILL_HERBLORE].level << ",";
	query << "`skill_herblore_tries` = " << player->skills[SKILL_HERBLORE].tries << ",";
	query << "`skill_alchemy` = " << player->skills[SKILL_ALCHEMY].level << ",";
	query << "`skill_alchemy_tries` = " << player->skills[SKILL_ALCHEMY].tries << ",";
	query << "`skill_archaeology` = " << player->skills[SKILL_ARCHAEOLOGY].level << ",";
	query << "`skill_archaeology_tries` = " << player->skills[SKILL_ARCHAEOLOGY].tries << ",";
	query << "`skill_music` = " << player->skills[SKILL_MUSIC].level << ",";
	query << "`skill_music_tries` = " << player->skills[SKILL_MUSIC].tries << ",";
	query << "`skill_wisdom` = " << player->skills[SKILL_WISDOM].level << ",";
	query << "`skill_wisdom_tries` = " << player->skills[SKILL_WISDOM].tries << ",";
