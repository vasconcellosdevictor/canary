...
enum ConditionParam_t {
	...
	CONDITION_PARAM_SKILL_SMITHING = 85,
	CONDITION_PARAM_SKILL_SMITHINGPERCENT = 86,
	CONDITION_PARAM_SKILL_ENCHANTING = 87,
	CONDITION_PARAM_SKILL_ENCHANTINGPERCENT = 88,
	CONDITION_PARAM_SKILL_WOODCUTTING = 89,
	CONDITION_PARAM_SKILL_WOODCUTTINGPERCENT = 90,
	CONDITION_PARAM_SKILL_FLETCHING = 91,
	CONDITION_PARAM_SKILL_FLETCHINGPERCENT = 92,
	CONDITION_PARAM_SKILL_SKINNING = 93,
	CONDITION_PARAM_SKILL_SKINNINGPERCENT = 94,
	CONDITION_PARAM_SKILL_BUTCHERING = 95,
	CONDITION_PARAM_SKILL_BUTCHERINGPERCENT = 96,
	CONDITION_PARAM_SKILL_FARMING = 97,
	CONDITION_PARAM_SKILL_FARMINGPERCENT = 98,
	CONDITION_PARAM_SKILL_COOKING = 99,
	CONDITION_PARAM_SKILL_COOKINGPERCENT = 100,
	CONDITION_PARAM_SKILL_CRAFTING = 101,
	CONDITION_PARAM_SKILL_CRAFTINGPERCENT = 102,
	CONDITION_PARAM_SKILL_HERBLORE = 103,
	CONDITION_PARAM_SKILL_HERBLOREPERCENT = 104,
	CONDITION_PARAM_SKILL_ALCHEMY = 105,
	CONDITION_PARAM_SKILL_ALCHEMYPERCENT = 106,
	CONDITION_PARAM_SKILL_ARCHAEOLOGY = 107,
	CONDITION_PARAM_SKILL_ARCHAEOLOGYPERCENT = 108,
	CONDITION_PARAM_SKILL_MUSIC = 109,
	CONDITION_PARAM_SKILL_MUSICPERCENT = 110,
	CONDITION_PARAM_SKILL_WISDOM = 111,
	CONDITION_PARAM_SKILL_WISDOMPERCENT = 112,
};
...
enum skills_t : int8_t {
	...
	SKILL_HERBLORE = 17,
	SKILL_ALCHEMY = 18,
	SKILL_ARCHAEOLOGY = 19,
	SKILL_MUSIC = 20,
	SKILL_WISDOM = 21,
	SKILL_CRITICAL_HIT_CHANCE = 22,
	SKILL_CRITICAL_HIT_DAMAGE = 23,
	SKILL_LIFE_LEECH_CHANCE = 24,
	SKILL_LIFE_LEECH_AMOUNT = 25,
	SKILL_MANA_LEECH_CHANCE = 26,
	SKILL_MANA_LEECH_AMOUNT = 27,
	SKILL_MAGLEVEL = 28,
	SKILL_LEVEL = 29,
